...
/**
 * @author Hieu Rocker (rockerhieu@gmail.com), 删除部分表情 by cidgeedeng
 */
public final class EmojiconHandler {
    ...
    private static final SparseIntArray sSoftbanksMap = new SparseIntArray(471+ QqClassic.Size);

    public static final char DeleteCode = 0xeeff;
    public static final int DeleteRes = R.drawable.emoji_delete;
    ...
    static {
    	...
    	//QqClassic
        int index = QqClassic.EmoijCode;
        for(int i = 0;i< QqClassic.Size;i++){
            sSoftbanksMap.put(index++,QqClassic.EmoijDrawable[i]);
        }
        //删除图标
        sSoftbanksMap.put(DeleteCode,DeleteRes);
