 ...
 */
public class EappCursorAdapter extends RecyclerView.Adapter<EappCursorAdapter.ViewHolder> {
    /**
     ...
     */
    public EappCursorAdapter(Context context, Cursor c, boolean autoRequery) {
     ...
     */
    public EappCursorAdapter(Context context, Cursor c, int flags) {
